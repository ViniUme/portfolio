...
export default {
    ...
    data(){
        return{
            items: ["/img/html.png", "/img/css.png", "/img/js.png", "/img/react.png", "/img/nextjs.png", "/img/mongodb.png", "/img/vue.png", "/img/sass.png", "/img/git.png", "/img/microsoftSQL.png", "/img/mk.png", "/img/office.png"]
        }
    }
}
</script>
